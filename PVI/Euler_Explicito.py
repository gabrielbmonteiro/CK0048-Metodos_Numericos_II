class Euler_Explicito:
    ...
    def __init__(self, delta_t):
        ...
        self.delta_t = delta_t  # Passo temporal para o método de Euler Explícito
    ...
    def pontos_criticos1(self):
        ...
        while y_atual > 0:
            # Atualiza a velocidade e a altura usando o método de Euler Explícito
            v_atual, y_atual = self.euler_explicito(v_ant, y_ant)
    ...
    # Método que resolve a equação diferencial usando o método de Euler Explícito
    def euler_explicito(self, v_antigo, y_antigo):
        # Atualiza a velocidade utilizando o método de Euler Explícito
        v_atual = v_antigo + self.delta_t * (-self.g - (self.k / self.m) * v_antigo)
        
        # Atualiza a altura utilizando o método de Euler Explícito
        y_atual = y_antigo + self.delta_t * v_antigo
